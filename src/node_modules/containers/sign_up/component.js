...
class SignUpContainer extends Component {
    ...
    onSubmit = () => {
        ...
        if(Object.keys(this.state.user).length !== 3) return
        ...
        if(this.state.user.password !== this.state.user.passwordAgain) {
            this.setState({passValid: false})
             ...
             toast.success(`Добро пожаловать , вы были анонимно зарегистрированны - ваши данные конфиданциальны`, {
                position: toast.POSITION.BOTTOM_RIGHT
            })
            const userId = Request('POST', this.state.user)
                if(userId){
    ...
    render() {
        ...
        return (
            <div className="login-container">
                ...
                <FluidInput type="text"  label="Login" id="name" style={style} onInputChange={this.onInputChange}/>
