...
const  Menu = ( props ) =>{
        ...
        <div>
            <div className="menu-overlay">
                <div className="wrapper">
                    <span className="index-header-logo">logo<img src="/img/helion.svg" width={30} alt="" /></span>
    ...
    {(!props.hideButton) ? null : <li><Link to='/profile-balance'><img src="/img/male-user.svg" width={25} alt="market" />profile</Link></li> }
                        </ul>{/* index-main-menu */}
                        {(!props.hideButton)?
